...
**用户:** `jaenergy`
**发现时间:** `2026-05-07 14:48:11`

## 表清单

| 表名 | 行数 | 注释 |
|------|------|------|
| JAE_MONTHLY_POWER_FEE | 3227847 |  |
| JAE_PS_BOM | 1001822 |  |
| JAE_MONTHLY_POWER_COMPARE | 100894 |  |
| JAE_PS | 100690 | 电站档案宽表 |
| JAE_CITIC_OWNER_INFO | 32939 |  |
| JAE_CITIC_PS_BASE_INFO | 32939 |  |
| JAE_CITIC_PS | 32939 |  |
| JAE_CITIC_PS_SCOPE | 32939 |  |
| JAE_DAILY_POWER_ABNORMAL | 2257 |  |
...
| 字段名 | 类型 | 可空 | 注释 |
|--------|------|------|------|
| ORDERID | NUMBER(38) | Y | 订单ID |
| STATIONNO | VARCHAR2(200) | Y | 电站编号 |
| HOUSEHOLDER_NAME | VARCHAR2(300) | Y | 业主姓名 |
| HOUSEHOLDER_ID | VARCHAR2(100) | Y | 业主身份证号码 |
| HOUSEHOLDER_PHONE | VARCHAR2(200) | Y | 业主联系电话 |
| PROVINCE | VARCHAR2(100) | Y | 省 |
| CITY | VARCHAR2(100) | Y | 市 |
| DISTRICT | VARCHAR2(100) | Y | 区县 |
| TOWN | VARCHAR2(100) | Y | 街道镇 |
| PSADDRESS | VARCHAR2(1900) | Y | 电站地址 |
| LATITUDE | VARCHAR2(255) | Y | 纬度 |
| LONGITUDE | VARCHAR2(255) | Y | 经度 |
| COLLECTIONTYPE | VARCHAR2(40) | Y | 电费归集方式 |
| PRODUCT_NAME | VARCHAR2(40) | Y | 产品名称 |
| BUSINESS_TYPE | VARCHAR2(40) | Y | 业务模式 |
| MERGE_FILING_TYPE | VARCHAR2(40) | Y | 电网并网（备案方式） |
| PS_TYPE | VARCHAR2(50) | Y | 电站类型 |
| PROJECT_COMPANY_NAME | VARCHAR2(100) | Y | 项目公司/产权方 |
| EPC | VARCHAR2(255) | Y | EPC方 |
| DEVELOPER_CODE | VARCHAR2(255) | Y | 一级开发商编号 |
| DEVELOPER_NAME | VARCHAR2(100) | Y | 一级开发商 |
| SERVICE_PROVIDER_CODE | VARCHAR2(255) | Y | 一级服务商编号 |
| SERVICE_PROVIDER_NAME | VARCHAR2(100) | Y | 一级服务商 |
| AGENT_CODE | VARCHAR2(255) | Y | 一级代理商编号 |
| AGENT_NAME | VARCHAR2(100) | Y | 一级代理商 |
| AGENT_LECAL | VARCHAR2(50) | Y | 一级代理商法人 |
| AGENT_PHONE | VARCHAR2(50) | Y | 一级代理商联系电话 |
| AGENT_LICENSE | VARCHAR2(100) | Y | 一级代理商营业执照号 |
| AGENT_ADDR | VARCHAR2(400) | Y | 一级代理商地址 |
| PS_STATE | VARCHAR2(40) | Y | 电站状态 |
| POWER_ACCOUNT | VARCHAR2(200) | Y | 发电户号 |
| FILING_CERT_CODE | VARCHAR2(255) | Y | 备案证代码 |
| COSIGNER_NAME | VARCHAR2(100) | Y | 共签人 |
| COSIGNER_ID | VARCHAR2(50) | Y | 共签人身份证号码 |
| COSIGNER_PHONE | VARCHAR2(50) | Y | 共签人联系电话 |
| RENT_SHARE_BANK_NAME | VARCHAR2(300) | Y | 业主租金分享卡开户行 |
| DESIGN_SCHEME | VARCHAR2(4000) | Y | 设计方案（可能存在一站多方案） |
| DESIGN_MODULE_TOTAL_PIECES | NUMBER(22) | Y | 设计组件块数 |
| DESIGN_TOTAL_CAPACITY | NUMBER(22) | Y | 设计装机容量 |
| SPEC_SOLUTION_TYPE | VARCHAR2(100) | Y | 特殊方案类型 |
| SPEC_SOLUTION_PIECES | NUMBER(38) | Y | 特殊方案块数 |
| INVERTER_COUNT | NUMBER(22) | Y | 逆变器数量 |
| CONTRACT_SIGN_TYPE | VARCHAR2(40) | Y | 合同签署方式 |
| FIRSTSTAGE_YEARCOUNT | NUMBER(22) | Y | 阶段一有效期（年） |
| FIRSTSTAGE_SHAREMONEY | NUMBER(22) | Y | 阶段一租金 |
| SECONDSTAGE_YEARCOUNT | NUMBER(22) | Y | 阶段二有效期（年） |
| SECONDSTAGE_SHAREMONEY | NUMBER(22) | Y | 阶段二租金 |
| THIRDSTAGE_YEARCOUNT | NUMBER(22) | Y | 阶段三有效期（年） |
| THIRDSTAGE_SHAREMONEY | NUMBER(22) | Y | 阶段三租金 |
| BUSINESS_CREATE_DATE | VARCHAR2(20) | Y | 商机创建日期 |
| SURVEY_FINISH_DATE | VARCHAR2(20) | Y | 勘察完成日期 |
| CONTRACT_CREATE_DATE | VARCHAR2(20) | Y | 合同创建日期 |
| CONTRACT_MERGE_DATE | VARCHAR2(20) | Y | 并网合同日期 |
| FILING_SUBMIT_DATE | VARCHAR2(20) | Y | 建档提交日期 |
| BUSINESS_REVIEW_FINISH_DATE | VARCHAR2(20) | Y | 商务审核完成日期 |
| TECH_REVIEW_FINISH_DATE | VARCHAR2(20) | Y | 技术审核完成日期 |
| FILING_REVIEW_PASSED_DATE | VARCHAR2(20) | Y | 建档审核通过日期 |
| FULL_DELIVER_DATE | VARCHAR2(20) | Y | 齐套发货日期 |
| DIPATCH_DATE | VARCHAR2(20) | Y | 派工日期 |
| COMPLETE_SUBMIT_DATE | VARCHAR2(20) | Y | 完工提交日期 |
| COMPLETE_CHECK_DATE | VARCHAR2(20) | Y | 完工审核通过日期 |
| MERGE_APPLY_DATE | VARCHAR2(20) | Y | 并网申请日期 |
| MERGE_BUSSINESS_REVIEW_DATE | VARCHAR2(20) | Y | 并网商务审核日期 |
| MERGE_ENGINEERING_REVIEW_DATE | VARCHAR2(20) | Y | 并网工程审核日期 |
| MERGE_REVIEW_PASS_DATE | VARCHAR2(20) | Y | 并网审核通过日期（并网日期） |
| COMPLETE_DATE | VARCHAR2(20) | Y | 竣工完成日期 |
| FIRST_POWER_DATE | VARCHAR2(20) | Y | 有效发电首日 |
| CONTRACT_SIGN_DATE | VARCHAR2(20) | Y | 租赁合同签约时间 |
| BUSINESS_OPPT_NO | VARCHAR2(50) | Y | 商机编号 |
| BUSINESS_OPPT_STATUS | VARCHAR2(40) | Y | 商机状态 |
| RENT_SHARE_BANK_ACCOUNT_NAME | VARCHAR2(100) | Y | 业主租金分享卡户名 |
| RENT_SHARE_BANK_ACCOUNT_NUM | VARCHAR2(100) | Y | 业主租金分享账号 |
| RENT_SHARE_BANK_CODE | VARCHAR2(200) | Y | 业主租金分享卡行号 |
| GRID_EARNING_BANK_ACCOUNT_NUM | VARCHAR2(100) | Y | 电费收益卡卡号 |
| GRID_EARNING_BANK_NAME | VARCHAR2(255) | Y | 电费收益开户行 |
| GRID_EARNING_BANK_ACCOUNT_NAME | VARCHAR2(255) | Y | 电费收益卡户名 |
| DEDUCTION_BANK_ACCOUNT_NAME | VARCHAR2(100) | Y | （批）扣款账户户名/开卡项目公司 |
| DEDUCTION_BANK_ACCOUNT_NUM | VARCHAR2(50) | Y | （批）扣款账户号 |
| DEDUCTION_BANK_NAME | VARCHAR2(40) | Y | （批）扣款开户行 |
| MODULE_TOTAL_PIECES | NUMBER(38) | Y | 组件块数 |
| MODULE_POWER | NUMBER(38) | Y | 组件功率 |
| TOTAL_CAPACITY | NUMBER(38) | Y | 装机容量/并网容量 |
| CONTRACT_SIGN_STATUS | VARCHAR2(20) | Y | 合同签署状态 |
| CONTRACT_SIGN_SECONDPART | VARCHAR2(200) | Y | 合同公司签署方 |
| CONTRACT_FIRST_EFFECTIVE_DATE | VARCHAR2(200) | Y | 首份生效合同创建日期 |
| BIRTHDAY | VARCHAR2(30) | Y | 出生年月日 |
| OWNWER_SIGN_AGE | VARCHAR2(20) | Y | 业主签约年龄 |
| PROVINCE_CODE | VARCHAR2(10) | Y | 省编码 |
| CITY_CODE | VARCHAR2(10) | Y | 市编码 |
| DISTRICT_CODE | VARCHAR2(10) | Y | 区县编码 |
| TOWN_CODE | VARCHAR2(10) | Y | 街道镇编码 |
| PROJCOMP_BANK_ACCOUNT | VARCHAR2(150) | Y | 项目公司银行账号 |
| PROJCOMP_BANK_NAME | VARCHAR2(150) | Y | 项目公司开户行 |
| INCOME_START_DATE | VARCHAR2(10) | Y | 租金起算日 |
| TAG_STATUS | VARCHAR2(10) | Y | 电站标记状态 |
| HOUSE_AGE | VARCHAR2(20) | Y | 房屋建设年代 |
| HOUSE_ORIENTATION | VARCHAR2(60) | Y | 房屋朝向 |
| HOUSE_CLINATION | VARCHAR2(60) | Y | 房屋朝向角度 |
...
```json
{
  ...
  "discovered_at": "2026-05-07 14:48:14"
}
```
-->